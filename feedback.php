...
<div class="col-lg-6">
<span class="logo"><i><u>Learn Today, Lead Tomorrow</u></i></span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-6 panel" style="background-image:url(image/5.jpg); min-height:430px;">
<h2 align="center" style="font-family:'typo'; color:#000066">FEEDBACK/REPORT A PROBLEM</h2>
<div style="font-size:14px">
<?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo' 
<b>You can send us your feedback through e-mail on the following e-mail id: nishu18@gmail.com</b><br />
<div class="row">
